...
Please refer to this article to learn more about Canadian horses [@milner1969weight]
...
```{r plot horses, fig.width=10, fig.height=3, fig.cap="Table 1. Maximum and minimum number of horses for each province between 1940-1972", out.width="100%"}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap="Table 2. Number of horses for province of focus", out.width='50%'}
